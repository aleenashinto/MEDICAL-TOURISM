...
let globalHospitalsStore: ServerHospital[] = [
  ...
  },
  {
    ...
    specialties: ["Neurology & Neurosurgery", "Cardiology & Bypass", "Comprehensive Oncology", "Living-Donor Transplants"],
    doctors: ["Dr. K. Suresh Kumar, MCh", "Dr. Madhavan Nair, MD"],
    facilities: ["Advanced Epilepsy Monitoring Unit", "Transplant ICU", "Advanced Sleep Lab", "Level 1 Trauma Care"],
    internationalServices: [
      "Dedicated Gulf International Desk",
      "Direct TRV Airport Chauffeur Service (10 mins)",
      "Medical Evacuation Coordination Desk"
    ],
    languages: ["English", "Arabic", "Malayalam", "Hindi", "Tamil"],
    vipRoomsAvailable: true,
    ayurvedaWingAvailable: false,
    rating: 4.91,
    reviewCount: 3640,
