...
export default function PatientDashboardPage() {
  return (
    <div className="space-y-6">
      {/* Welcome Banner */}
      <div className="bg-gradient-to-r from-[#0F2042] via-[#1E3A8A] to-[#0E82FD] rounded-2xl p-6 md:p-8 text-white shadow-xl relative overflow-hidden">
        <div className="relative z-10 max-w-2xl">
          <span className="px-3 py-1 rounded-full text-xs font-semibold bg-white/20 text-white backdrop-blur-md inline-block mb-3">
            Case ID: MED-2026-00125
          </span>
          ...
          <p className="text-blue-100 text-sm md:text-base mt-2 leading-relaxed">
            ...
            <span className="font-semibold text-white">Travel & Logistics Planning</span>.
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
          ...
          <div className="mt-3">
            <div className="text-lg font-bold text-slate-900">Off-Pump CABG</div>
        ...
        <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
          ...
          <div className="mt-3">
            <div className="text-lg font-bold text-slate-900">15 Oct 2026</div>
        ...
        <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
          ...
          <div className="mt-3">
            <div className="text-lg font-bold text-emerald-600">Letter Issued</div>
        ...
        <div className="bg-white p-5 rounded-xl border border-slate-200 shadow-sm">
          ...
          <div className="mt-3">
            <div className="text-lg font-bold text-slate-900">$2,000 Paid</div>
