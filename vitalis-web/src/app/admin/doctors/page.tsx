...
const INITIAL_DOCTORS: Doctor[] = [
  ...
  },
  {
    ...
    department: "Classical Panchakarma & Restorative Healing",
    displayOrder: 4,
    status: "ACTIVE",
    published: "PUBLISHED",
    ...
    fullBiography: "A revered Ashtavaidya practitioner bridging ancient Charaka Samhita wisdom with modern clinical evidence for chronic immune and metabolic ailments.",
