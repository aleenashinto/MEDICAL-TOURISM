...
const INITIAL_PACKAGES: PackageOffer[] = [
  ...
  },
  {
    ...
    transportType: "Private Air-Conditioned Sedan Airport Transfer (TRV)",
  ...
  },
  {
    ...
    accommodationType: "Executive Hospital Suite + Convalescence Stay",
    transportType: "Executive Airport Chauffeur (COK)",
