...
const INITIAL_TREATMENTS: TreatmentItem[] = [
  {
    ...
    description: "High-precision computer-navigated arthroplasty using US-FDA approved titanium and ceramic implants with rapid recovery protocols.",
  ...
  },
  {
    ...
    description: "Minimally invasive endoscopic robotic heart surgery for degenerative mitral regurgitation with minimal blood loss and swift discharge.",
    inclusions: ["Cardiothoracic surgical team", "ICU & Cardiac monitoring (3 days)", "Private room (4 days)", "Intraoperative TEE echo"],
  ...
  },
  {
    ...
    description: "Traditional 5-action Ayurvedic detoxification, Abhyangam, Shirodhara, customized herbal pharmacology, and holistic organic wellness regimen.",
  ...
  },
  {
    ...
    description: "Sub-millimeter pencil-beam scanning proton radiotherapy targeting pediatric, skull-base, and recurrent solid tumors while sparing critical adjacent healthy tissues.",
    inclusions: ["Radiation oncologist treatment planning", "4D-CT simulation", "Targeted beam delivery cycles", "Dosimetry quality assurance"],
    hospitals: ["Amrita Institute of Medical Sciences", "Aster Medcity, Kochi"],
    status: "ACTIVE"
  },
  {
    id: "TRT-005",
    name: "Advanced Robotic Bariatric & Sleeve Gastrectomy",
    code: "BARI-SG-05",
    specialty: "Bariatric & Metabolic Surgery",
    duration: "3 - 4 Days Hospital Stay",
    costUSD: 5400,
    costINR: 448200,
    usCostUSD: 28000,
    usSavings: "Save 78% vs US ($28,000)",
    description: "Laparoscopic and DaVinci robot-assisted sleeve gastrectomy for metabolic syndrome, diabetic remission, and clinically guided weight reduction.",
    inclusions: ["Surgical & anaesthesia team", "Endo GIA tri-stapler cartridges", "Post-op bariatric nutritionist planning (6 months)", "Private suite stay"],
    hospitals: ["VPS Lakeshore, Kochi", "Apollo Adlux Hospital, Angamaly"],
    status: "ACTIVE"
  },
  {
    id: "TRT-006",
    name: "Full Mouth Dental Rehabilitation & All-on-4 Implants",
    code: "DENT-AO4-06",
    specialty: "Dental & Maxillofacial",
    duration: "5 - 7 Days (2 visits)",
    costUSD: 3600,
    costINR: 298800,
    usCostUSD: 24000,
    usSavings: "Save 85% vs US ($24,000)",
    description: "Immediate loaded Swiss/German grade Nobel Biocare implants with CAD/CAM zirconia monolithic fixed bridges.",
    inclusions: ["4/6 Titanium implants per jaw", "Zirconia temporary & permanent prostheses", "CBCT 3D Bone Scans", "Antibiotic therapy"],
    hospitals: ["Aster Medcity Dental Specialty", "Rajagiri International Dental Wing"],
    status: "ACTIVE"
  }
];
